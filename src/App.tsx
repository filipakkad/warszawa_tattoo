...
function App() {
  ...
  return (
      <div>
        <noscript>
          <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MJ9GMN8" height="0" width="0"
                  style={{display: 'none', visibility: 'hidden'}}></iframe>
        </noscript>
        <script src="assets/vendor/jquery/jquery.min.js"></script>


        <header id="header" className={clsx("fixed-top", {mobile: (width ?? 0) < 768 })}>
        ...
        <section id="hero" className="counts">
          <div className="hero-container">
            ...
            <div className="pt-10 flex-col gap-2 items-list-main hidden md:flex">
              <A className="flex justify-between md:gap-10 items-center md:flex-row flex-col gap-2"
                 href="#weeklyCourse">
                <span
                    className="max-w-[300px] font-bold text-nowrap text-center md:!text-left">Kurs tygodniowy (40H)</span>
                <span className="text-nowrap">3000 zł</span>
              </A>
              <A className="flex justify-between md:gap-10 items-center md:flex-row flex-col gap-2"
                 href="#weekendCourse">
                <span
                    className="max-w-[300px] font-bold text-nowrap text-center md:!text-left">Kurs weekendowy (48H)</span>
                <span className="text-nowrap">4000 zł</span>
              </A>
              <A className="flex justify-between md:gap-10 items-center md:flex-row flex-col gap-2"
                 href="#twoWeeksCourse">
                <span
                    className="max-w-[300px] font-bold text-nowrap text-center md:!text-left">Kurs dwutygodniowy (80H)</span>
                <span className="text-nowrap">
            <span className="line-through">6000 zł</span>
            <span> 5000 zł</span>
          </span>
              </A>
              <a className="flex justify-between md:gap-10 items-center md:flex-row flex-col gap-2"
        ...
        <section className="flex md:hidden justify-center bg-[#0000006e] text-sm">
          <div className="flex flex-col gap-2 items-list-main w-full px-4">
        ...
        <main id="main">
          <section id="about" className="about">
            <div className="container">
              <div className="section-title">
                <h2>Dlaczego my?</h2>
                <p>Jest kilka firm w Polsce organizujących Kursy Tatuażu. Natomiast tylko profesjonalne Studia Tatuażu
                  są
                  w
                  ...
                  <ul className="faq-list">
                    ...
                    <li>
                      ...
                      <div id="faq3" className="collapse" data-bs-parent=".faq-list">
                        <p>
                          Nasze kursy to jedyna taka oferta w Polsce. 40, 48 bądź 80 godz. za 3, 4 bądź 5 tyś. zł.
          ...
          <section id="twoWeeksCourse" className="about">
            <div className="container">
              ...
              <div className="section-title">
                <h2>Kurs dwutygodniowy (80H) - <span className="line-through">6000 zł</span> 5000 zł</h2>
              </div>
              <div id="services" className="services">
                <div className="row" id="editions">
                  <h3>Terminy</h3>
